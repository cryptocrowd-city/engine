...
class Confirmation extends EmailCampaign
{
    ...
    public function build()
    {
        ...
        $subject = $translator->translate('Welcome to Minds. Time to verify.');
        ...
        $this->template->set('title', $translator->translate('Welcome to Minds'));
        $this->template->set('preheader', $subject);

        $actionButton = (new ActionButton())
        ->setLabel($translator->translate('Verify Address'))
